...
export default function ResumeEditor({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [resumeData, setResumeData] = useState<ResumeData>({
    id: resolvedParams.id, // Use the resolved params
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      // If the content is too long, adjust the height
  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Store parsed content for analysis
      try {
        localStorage.setItem(`resume-${resolvedParams.id}`, JSON.stringify(resumeData));
      } catch (storageError) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8">
          ...
          <div className="flex gap-4">
            ...
            <button 
              ...
              className="bg-gradient-to-r from-green-500 to-blue-600 text-white px-8 py-3 rounded-xl hover:from-green-600 hover:to-blue-700 transition-all font-semibold shadow-lg hover:shadow-xl flex items-center gap-2"
            >
              <span>📥</span>
              Download PDF
            </button>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-gray-100">
              ...
              <div className="flex flex-wrap gap-3 mb-4">
                {resumeData.skills.map((skill, index) => (
                  <div key={index} className="bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 px-4 py-2 rounded-xl font-medium border border-blue-200 flex items-center gap-2">
                    {skill}
                    <button 
          ...
          {/* Right Side - Preview and Chatbot */}
          <div className="space-y-6">
            ...
            {/* AI Chatbot Sidebar */}
            {showChatbot && (
              <div className="bg-white rounded-2xl shadow-xl border border-gray-200 flex flex-col max-h-[400px]">
                {/* Chat Header */}
