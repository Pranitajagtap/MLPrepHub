      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {careers.map((career) => (
            ...
            >
              <div className={`absolute top-0 left-0 w-full h-1 bg-gradient-to-r ${career.gradient}`}></div>
              <div className="p-6">
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                    <div 
                      className={`h-2 rounded-full bg-gradient-to-r ${career.gradient} transition-all duration-1000 ease-out`}
                ...
                <div className="space-y-2">
                  <Link 
                    ...
                    className="block w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white text-center py-2.5 rounded-xl hover:shadow-lg transition-all duration-300 font-semibold text-sm"
                  >
                    Explore Path
                  </Link>
                  <Link 
